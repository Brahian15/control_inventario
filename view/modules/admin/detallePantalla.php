<div class="row z-depth-4" id="cuerpo">
  ...
  <form action="?c=admin&a=UpdatePantalla" method="post">
    ...
    <div class="input-field col s4 offset-s2">
      <input type="text" name="data[]" value="<?php echo $data->pant_id; ?>">
      <label>ID</label>
    </div>

    <div class="input-field col s4">
      <input type="text" name="data[]" value="<?php echo $data->pant_serial; ?>" required>
      <label>Serial</label>
    </div>

    <div class="input-field col s4 offset-s2">
      <input type="text" name="data[]" value="<?php echo $data->pant_type; ?>" required>
      <label>Type</label>
    </div>

    <div class="input-field col s4">
      <input type="text" name="data[]" value="<?php echo $data->pant_consecutivo ?>" required>
  ...
  <a href="?c=admin&a=ReadPantalla" class="btn waves-effect waves-light col s4 blue-grey darken-2">Cancelar</a>
